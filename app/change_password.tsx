...
const getStrength = (pwd: string): { label: string; color: string; score: number } => {
  ...
  return { label: "Strong", color: "#4F46E5", score: 3 }; // Aligned to Theme Indigo
};
    ...
    return (
      <View style={styles.errorContainer}>
        ...
        <Text style={styles.errorSubtitle}>
          EXPO_PUBLIC_API_BASE environment variable is not defined. Please verify system configurations.
        </Text>
      </View>
    );
  }
  ...
  return (
    ...
    >
      ...
      >
        {/* ── HERO ── */}
        <LinearGradient
          colors={["#4F46E5", "#3730A3"]} // Cohesive Corporate Indigo Profile
          ...
          <View style={styles.card}>
            ...
            <View style={styles.tipsBox}>
              ...
              <Text style={styles.tipsText}>
                Use at least 6 characters with a mix of uppercase, lowercase letters, numbers & symbols for a highly secure account.
              </Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  content: { flex: 1, paddingHorizontal: 18, marginTop: -20, marginBottom: 24 },
  card: {
  ...
  input: { flex: 1, fontSize: 14, color: "#111", ...Platform.select({ web: { outlineStyle: "none" } }) } as any,
  ...
  tipsBox: {
    ...
    backgroundColor: "#EEF2F6", borderRadius: 12,
    padding: 12, marginBottom: 20,
  },
  tipsText: { flex: 1, fontSize: 12, color: "#334155", lineHeight: 17 },
  ...
  errorSubtitle: { fontSize: 13, color: "#4B5563", textAlign: "center", lineHeight: 20 },
});